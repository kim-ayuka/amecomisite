...
.section--dots::after{
    position: absolute;
    content: "";
    background-image: url(/img/all_dots-bg.png);
...
.tv__button_item:last-child::after{
    position: absolute;
    content: "";
    background-image: url(/img/all_dots_shadow_small.png);
    background-size: 100%;
    width: 100%;
    height: 100%;
    top: 20px;
...
.campaign--cloud{
    background-image: url(/img/reoson_cloud.png);
    height: 150%;
...
.campaign--spark{
    background-image: url(/img/campaign_spark.png);
...
.target__list__item:first-child{
    background-image: url(/img/target_1.png);
    /* width: 517px; */
    /* height: 255px; */
    top: 0px;
    left: 240px;
...
.target__list__item:nth-child(2){
    background-image: url(/img/target_2.png);
    /* width: 426px; */
    /* height: 256px; */
    top: 160px;
    left: 920px;
...
.target__list__item:nth-child(3){
    background-image: url(/img/target_3.png);
    /* width: 476px; */
    /* height: 252px; */
    top: 250px;
    left: 420px;
...
.target__list__item:last-child{
    background-image: url(/img/target_4.png);
    /* width: 567px; */
    /* height: 308px; */
    font-size: 1.8rem;
    font-weight: 800;
...
.target__guide::after{
    position: absolute;
    content: "";
    background-image: url(/img/target_guide.png);
    background-size: 100% 100%;
    width: 97%;
    height: 100%;
    top: 32px;
...
.section__heading--miss--pattern{
    font-size: 3.9rem;
    background: url(/img/miss_heading_bg.png);
    background-size: cover;
    background-clip: text;
    color: transparent;
}
...
.contact{
    padding: 100px 0;
    background-image: url(/img/all_dots-bottom.png);
...
.side-menu__list__item:first-child > .side-menu__list__item__link{
    background-image: url(/img/side-menu_line.png);
    padding-top: 35px;
}
.side-menu__list__item:last-child > .side-menu__list__item__link{
    background-image: url(/img/side-menu_form.png);
}
